...
const routes: Routes = [
  ...
  { path: 'genre/:type/:name/:id', loadChildren: './genres/genre-movie/genre-movie.module#GenreMoviePageModule' },
  { path: 'genre/:type/:name/:id', loadChildren: './genres/genre-show/genre-show.module#GenreShowPageModule' },
];
